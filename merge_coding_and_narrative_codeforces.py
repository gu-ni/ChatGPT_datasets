...
with open(input_jsonl_path, "r", encoding="utf-8") as infile, \
    open(codeforces_in_lcb_format_path, "r", encoding="utf-8") as codeforces_in_lcb_format, \
    ...
    for i, line in enumerate(infile):
        try:
            ...
            for cf_lcb_format in codeforces_in_lcb_format:
                try:
                    cf_lcb_problem = json.loads(cf_lcb_format)
                    if cf_lcb_problem["question_id"] and cf_lcb_problem["question_id"] == qid:
                        narrative = problem.get("question_content")
                        coding_test = cf_lcb_problem.get("question_content")
